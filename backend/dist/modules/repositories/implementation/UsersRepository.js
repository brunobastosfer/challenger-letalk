...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.create = function (_a) {
        var nome = _a.nome, cpf = _a.cpf, data_nascimento = _a.data_nascimento, emprestimo = _a.emprestimo, uf = _a.uf, parcelas = _a.parcelas;
    ...
    UserRepository.prototype.filterByName = function (cpf) {
        return __awaiter(this, void 0, void 0, function () {
            var find;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.repository.findOne({ cpf: cpf })];
                    case 1:
                        find = _a.sent();
